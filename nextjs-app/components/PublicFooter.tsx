    ...
    <footer className="py-12 px-6 border-t border-[#E5E2DB] bg-[#F7F4EF]">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Features Column 1 */}
          <div>
            <h4 className="font-semibold text-sm mb-4 text-[#1A1A1A]">Systems</h4>
          ...
          {/* Features Column 2 */}
          <div>
            <h4 className="font-semibold text-sm mb-4 text-[#1A1A1A]">More Features</h4>
            <ul className="space-y-2 text-sm text-[#666]">
          ...
          {/* Company */}
          <div>
            <h4 className="font-semibold text-sm mb-4 text-[#1A1A1A]">Company</h4>
            <ul className="space-y-2 text-sm text-[#666]">
              <li><Link href="/#testimonials" className="hover:text-[#1A1A1A] transition-colors">Reviews</Link></li>
