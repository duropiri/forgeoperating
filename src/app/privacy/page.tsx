...
export const metadata: Metadata = {
  title: "Privacy Policy | Forge Operating Group",
  description: "Privacy Policy for Forge Operating Group - Learn how we collect, use, and protect your information.",
};
    ...
    <div className="min-h-screen bg-white text-[#0A0A0A]">
      ...
      <main className="pt-28 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-4 text-[#0A0A0A]">Privacy Policy</h1>
          <p className="text-[#3B3B3B] mb-8">Last updated: January 2025</p>

          <div className="prose prose-lg max-w-none">
            <div className="space-y-8">
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">1. Introduction</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">2. Information We Collect</h2>
                <p className="text-[#3B3B3B] leading-relaxed mb-4">We collect information you provide directly to us, including:</p>
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">3. How We Use Your Information</h2>
                <p className="text-[#3B3B3B] leading-relaxed mb-4">We use the information we collect to:</p>
                <ul className="list-disc pl-6 text-[#3B3B3B] space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">4. Information Sharing</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">6. Your Rights</h2>
                <p className="text-[#3B3B3B] leading-relaxed mb-4">You have the right to:</p>
                <ul className="list-disc pl-6 text-[#3B3B3B] space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">7. Cookies and Tracking</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
