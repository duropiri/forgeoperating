...
export const metadata: Metadata = {
  title: "Terms of Service | Forge Operating Group",
  description: "Terms of Service for Forge Operating Group - Read our terms and conditions for using our services.",
};
    ...
    <div className="min-h-screen bg-white text-[#0A0A0A]">
      ...
      <main className="pt-28 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-4 text-[#0A0A0A]">Terms of Service</h1>
          <p className="text-[#3B3B3B] mb-8">Last updated: January 2025</p>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">2. Description of Service</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">3. Account Registration</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">4. Acceptable Use</h2>
                <p className="text-[#3B3B3B] leading-relaxed mb-4">You agree not to:</p>
                <ul className="list-disc pl-6 text-[#3B3B3B] space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">5. Payment Terms</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">6. Cancellation</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">7. Intellectual Property</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">8. Limitation of Liability</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">9. Disclaimer of Warranties</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">10. Changes to Terms</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#0A0A0A]">11. Contact</h2>
                <p className="text-[#3B3B3B] leading-relaxed">
